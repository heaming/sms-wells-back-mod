...
public class WsnaLogisticsInStorageAskService {
     ...
     */
    @Transactional
    public int createInStorageAsks(List<WsnaLogisticsInStorageAskDto.SaveReq> dtos) {
        ...
        if (CollectionUtils.isNotEmpty(dtos)) {
            ...
            for (String ostrAkNo : ostrAkNos) {
                ...
                if (ObjectUtils.isNotEmpty(askDvo)) {
                    count += this.insertRtngdAkDtlSendEtxt(askDvo, itms);
                }
            }
        }
     ...
     */
    @Transactional
    public WsnaLogisticsInStorageAskDvo insertPdRtngdAkSendEtxt(WsnaLogisticsInStorageAskDto.SaveReq dto) {
     ...
     */
    @Transactional
    public int insertRtngdAkDtlSendEtxt(
        WsnaLogisticsInStorageAskDvo askDvo, List<WsnaLogisticsInStorageAskDto.SaveReq> dtos
    ) {
    ...
    @Transactional
    public int removeInStorageAsks(@Valid
            ...
            for (String ostrNo : ostrNos) {
                ...
                if (ObjectUtils.isEmpty(removeCount)) {
                    ...
                    if (ObjectUtils.isNotEmpty(askDvo)) {
                        ...
                        this.mapper.updatePdRtngdAkSendEtxtForRemove(askDvo);
                    }
                }
            }
        }
     ...
     */
    private LogisticsInStorageCancelResIvo cancelLogisticsInStorage(
