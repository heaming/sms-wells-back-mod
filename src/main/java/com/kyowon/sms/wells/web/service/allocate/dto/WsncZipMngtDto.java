...
public class WsncZipMngtDto {
    ...
    @ApiModel(value = "WsncZipMngtDto-SearchZipCodeReq")
    public record SearchZipCodeReq(
        String zipFrom,
        String zipTo,
        String ctpvNm,
        String ctctyNm,
    ...
    // Result Dto
    // *********************************************************
    @ApiModel(value = "WsncZipMngtDto-SearchZipCodeRes")
    public record SearchZipCodeRes(
