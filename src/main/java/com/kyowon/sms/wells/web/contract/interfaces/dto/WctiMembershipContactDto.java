...
public class WctiMembershipContactDto {
    // *********************************************************
    // Request Dto
    // *********************************************************
    // 멤버십 계약 접수 현황 조회 Search Request Dto
    @Builder
    @ApiModel("WctiMembershipContactDto-SearchReq")
    ...
    // Result Dto
    // *********************************************************
    // 멤버십 계약 접수 현황 조회 Search Result Dto
    @ApiModel("WctiMembershipContactDto-SearchRes")
